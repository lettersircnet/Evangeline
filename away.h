...
const char *dzony_back[] = {
  "Los jest œlepy, ale trafia bez pud³a.",
  "Mniejsze z³o jest zwykle trwalsze.",
  "Nic tak nie mêczy jak cudzy wypoczynek.",
  "Piwo jest napojem ch³odz¹cym zapa³ do pracy.",
  "Przypadkowy bohater nigdy nie wspomina o przypadku.",
  "S³abym pozostaje tylko jedna broñ: b³êdy silnych.",
  "Suma zer daje groŸn¹ liczbê.",
  "Œmieræ jest lekka. Tylko chwila przed zgonem jest straszna.",
  "Number Nine. Number Nine. Number Nine. Number Nine. Number Nine.",
  "Tragedia: miejsce, w którym tchórze umieraj¹, a bohaterowie gin¹.",
NULL
};
...
const char *dzony_away[] = {
  ...
  "Wyj¹tki rozs³awiaj¹ regu³ê.",
  "Z³oty cielec jest tylko pewn¹ odmian¹ byd³a.",
  "¯yæ d³ugo chc¹ wszyscy, ale starym nikt nie chce byæ.",
  "Brak wstrz¹sów powoduje niepokój twórczy",
  "nie ma mnie. trupem pad³em.",
  "Demokracja: mówisz, co chcesz, robisz, co ci ka¿¹.",
  "Ekspert to cz³owiek, który przesta³ myœleæ - on wie.",
NULL
};
...
const char *luzik_back[] = {
  "piêkno zasmuca idiotów, a cieszy m¹drych.",
  "pope³nij z³y uczynek dwa razy, a przestaniesz go uwa¿aæ za grzech.",
  "najgorsze jest zepsucie najlepszego (zepsute najlepsze staje siê najgorszym).",
  "puste beczki wydaj¹ najg³oœniejsze dŸwiêki.",
  "doœwiadczenie to miano, którym ka¿dy okreœla swoje b³êdy.",
  "niewielu mo¿e nam pomóc, prawie ka¿dy mo¿e nam zaszkodziæ.",
  "daj mi ³ó¿ko i ksi¹¿kê, a bêdê szczêœliwy.",
  "uczciwoœæ to piêkny klejnot, ale bardzo niemodny.",
  "nie lubiê zasad, wolê przes¹dy.",
  "jeœli do niczego nie d¹¿ysz, nic nie osi¹gniesz.",
NULL
};

const char *luzik_away[] = {
  "pracowitoœæ jest Ÿród³em wszelkiej brzydoty.",
  "to podwójna przyjemnoœæ oszukaæ oszusta.",
  "trudno jest nie byæ niesprawiedliwym dla osoby, któr¹ siê kocha.",
  "³atwo jest znosiæ nieszczêœcia innych.",
  "m¹dry to mówca, który wie, kiedy nie ma nic do powiedzenia.",
  "daleka jest droga do celu.",
  "¿ycie to szpital, w którym ka¿dy pacjent chce zmieniæ ³ó¿ko.",
  "cz³owieka czêsto bardziej denerwuj¹ drobiazgi ni¿ powa¿ne rzeczy.",
  "ludzie mêcz¹ siê w pogoni za odpoczynkiem.",
  "w dzisiejszych czasach œpiewa siê o tym, o czym nie warto mówiæ.",
NULL
};
...
const char *mirc_back[] = {
  ...
  "wspania³omyœlnoœæ jest istot¹ przyjaŸni.",
  "ten, kto zakochuje siê sam w sobie, nie ma rywali.",
  "nigdy nie jest za póŸno, ¿eby siê poprawiæ.",
  "zachowaj pogodê, nie martw siê.",
...
const char *evangeline_away_add[] = {
"goes away. ",
NULL
};

const char *evangeline_back_add[] = {
"returned. ",
NULL
};
#endif
